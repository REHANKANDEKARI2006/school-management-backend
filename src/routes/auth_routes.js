...
import { 
  login, refreshToken, getProfile, updateProfile, changePassword, 
  uploadAvatar, inviteUser, resendInvitation, verifyInviteToken, 
  setPassword, forgotPassword, resetPassword, verifyResetToken, 
  getUsers, updateUserStatus, deleteUser,
  getSetupStatus, setupMasterAdmin, setupSchool, switchSchool, getMySchools 
...
router.post("/setup-school", authMiddleware, upload.single("file"), setupSchool);
router.post("/switch-school", authMiddleware, switchSchool);
router.get("/my-schools", authMiddleware, getMySchools);
